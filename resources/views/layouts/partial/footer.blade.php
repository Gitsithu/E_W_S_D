 <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2020 Concept. All rights reserved. Dashboard by Si Thu Nyunt Swe.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
    ...
    <script src="/backend/assets/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js"></script>
    <script src="/backend/assets/vendor/datatables/js/buttons.bootstrap4.min.js"></script>
    <script src="/backend/assets/vendor/datatables/js/data-table.js"></script>
